...
internal
class KotlinApiMemberWriter private constructor(apiMemberAdapter: ClassVisitor) :
    JavaApiMemberWriter(apiMemberAdapter) {
        ...
        classMember.annotations.firstOrNull {
            ...
            when (val kotlinMetadata = KotlinClassMetadata.read(parseKotlinClassHeader(it))) {
                ...
                is KotlinClassMetadata.Unknown -> {
                    throw ApiClassExtractionException(
                        "Unknown Kotlin metadata with kind: ${kotlinMetadata.header.kind} on class ${classMember.name} - " +
